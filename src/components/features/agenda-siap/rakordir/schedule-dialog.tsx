...
import { scheduleBulkRakordirAgendas } from "@/server/actions/agenda-siap-actions" // ✅ Import Action RAKORDIR
...
export function ScheduleDialog({ open, onOpenChange, selectedAgendas, onSuccess }: ScheduleDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // ✅ Panggil Action RAKORDIR
            const result = await scheduleBulkRakordirAgendas(ids, {
                executionDate: date,
                startTime,
                endTime,
            ...
            <DialogContent className="max-w-lg">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 text-[#006070]">
                        ...
                        PENETAPAN JADWAL MASSAL (RAKORDIR)
                    </DialogTitle>
                    <DialogDescription>
