...
import { AgendaGrid } from "../radir/agenda-grid"; // Reuse Grid
...
export function AgendaMain({ initialData }: AgendaMainProps) {
    ...
    return (
        <div className="flex flex-col h-full space-y-4">
            ...
            <DeleteKepdirDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog} ids={deleteIds} onSuccess={() => { setRowSelection({}); router.refresh(); }} />
        </div>
    );
}
