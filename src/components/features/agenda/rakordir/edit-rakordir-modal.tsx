...
import { updateRakordirAction, getRakordirById } from "@/server/actions/rakordir-actions"
...
export function EditRakordirModal({ open, onOpenChange, agendaId }: EditRakordirModalProps) {
    ...
    useEffect(() => {
        if (open && agendaId) {
            ...
            const fetchAgenda = async () => {
                const rawData = await getRakordirById(agendaId)
    ...
    async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            const result = await updateRakordirAction(agendaId, formData)
